// ============================================================
// Google Apps Script - コーパス演習 出席・ふりかえり管理システム
// （同志社女子大学学芸学部メディア創造学科 / 2026年度）
// ============================================================
//
// ※ 本スクリプトはコーパス演習（2026年度）用に新規にデプロイ
//    してください。スプレッドシートも新しく作成し、得られた
//    ウェブアプリURLを各セッションHTMLの SCRIPT_URL に設定します。
// ============================================================
//
// 【セットアップ手順】
...
// 授業名（メール件名に使用）
const COURSE_NAME = 'コーパス演習（2026年度）';
